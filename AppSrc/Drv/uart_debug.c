...
void initSerialInterface(void)
{
    ...
    ascConf.txBuffer = g_drv_asc_lin_uart.uart_tx_buffer;                      /* Set the transmission buffer                          */
    ascConf.txBufferSize = ASC_TX_BUFFER_SIZE;              /* Set the transmission buffer size                     */
    ascConf.rxBuffer = g_drv_asc_lin_uart.uart_rx_buffer;                      /* Set the receiving buffer                             */
    ascConf.rxBufferSize = ASC_RX_BUFFER_SIZE;              /* Set the receiving buffer size                        */

    /* Init ASCLIN module */
    IfxAsclin_Asc_initModule(&g_drv_asc_lin_uart.asclin, &ascConf);          /* Initialize the module with the given configuration   */
}
