...
static volatile IfxStm_Timer Timer[6];
static volatile Ifx_STM *const STM[6] = {&MODULE_STM0, &MODULE_STM1, &MODULE_STM2, &MODULE_STM3, &MODULE_STM4, &MODULE_STM5};

volatile Ifx_SRC_SRCR *const GPSR[6] = {&SRC_GPSR_GPSR0_SR0, &SRC_GPSR_GPSR1_SR0, &SRC_GPSR_GPSR2_SR0, &SRC_GPSR_GPSR3_SR0, &SRC_GPSR_GPSR4_SR0, &SRC_GPSR_GPSR5_SR0};
/*-----------------------------------------------------------*/
