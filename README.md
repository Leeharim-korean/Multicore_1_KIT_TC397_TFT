...
# This project is for multi core board but not for SMP - It means FreeRTOS is ported on only CPU0. If you createTask at other cpu, the Task is run at CPU0, not run at own CPUn
